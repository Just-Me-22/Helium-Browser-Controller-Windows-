...
function getSqlite3Path(): string {
  ...
  const possiblePaths = [
    path.join(extensionRoot, "assets", "sqlite3.exe"),
    path.resolve(extensionRoot, "assets", "sqlite3.exe"),
    path.join(extensionRoot, "bin", "sqlite3.exe"),
    path.resolve(extensionRoot, "bin", "sqlite3.exe"),
    path.join(extensionRoot, "..", "assets", "sqlite3.exe"),
    path.join(extensionRoot, "..", "bin", "sqlite3.exe"),
    path.resolve(extensionRoot, "..", "assets", "sqlite3.exe"),
    path.resolve(extensionRoot, "..", "bin", "sqlite3.exe"),
  ...
  throw new Error(
    `sqlite3.exe not found. Please ensure sqlite3.exe is in the assets or bin folder.`,
  );
}
